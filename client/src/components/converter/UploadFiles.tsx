...
const UploadFiles: FC<UploadFilesProps> = ({ 
  ...
  // Step 5: Proceed with selected repository - SHOW IN MAIN COMPONENT
  const handleProceedWithRepo = () => {
  ...
  // Handle analyzing repository directly
  const handleAnalyzeRepository = () => {
    if (!importedRepo) return;
    
    console.log('Analyzing repository:', {
      name: importedRepo.name,
      url: importedRepo.html_url,
      cloneUrl: importedRepo.clone_url,
      owner: importedRepo.owner.login,
  ...
  return (
    <div className="p-8">
      ...
      {/* Import Zone or Imported Repository */}
      {!importedRepo ? (
        ...
        /* Imported Repository Details Card */
        <div className="border-2 border-indigo-200 rounded-xl mb-6 overflow-hidden bg-white">
          ...
          <div className="p-6">
            ...
            <div className="space-y-3 mb-6">
              <div>
                <p className="text-sm text-gray-600 mb-2 font-medium">Repository URL</p>
                <div className="flex items-center gap-2">
                  <code className="flex-1 bg-gray-50 px-4 py-3 rounded-lg border border-gray-200 text-sm font-mono">
                    {importedRepo.html_url}
                  </code>
                  <a
                    href={importedRepo.html_url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-indigo-600 hover:text-indigo-700 p-3 hover:bg-indigo-50 rounded-lg transition-colors"
              ...
              <div>
                <p className="text-sm text-gray-600 mb-2 font-medium">Clone URL</p>
                <code className="block bg-gray-50 px-4 py-3 rounded-lg border border-gray-200 text-sm font-mono">
                  {importedRepo.clone_url}
                </code>
              </div>
            </div>
            ...
            <div className="flex justify-end pt-4 border-t border-gray-200">
              <button
                ...
                className="bg-indigo-500 text-white px-6 py-3 rounded-lg hover:bg-indigo-600 transition-colors flex items-center gap-2 font-medium"
              >
                Analyze Repository
